<x-layout>
    <div class="w-full h-full grid grid-cols-[15%,1fr] gap-2 bg-[#f6f6f9]">
        ...
        <main class="ml-17rem w-full pb-[100px]">
            <div>
                    ...
                    <div class="table_container">
                        <form class="max-w-md mx-auto" method="POST" action="{{route('business_admin.store_business')}}" enctype="multipart/form-data">
                            ...
                            {{-- <div class="relative z-0 w-full mb-5 group">
                                ...
                                <h1 class="font-bold">Business Requierments</h1>
                            @foreach ($requirements as $requirement)
                                <div class="relative z-0 w-full mb-5 group">
                                    <h1 class="font-semibold text-sm">{{$requirement->requirement_name}}</h1>
                                    <div class="max-w-xs">
                            ...
                            <div class="relative z-0 w-full mb-5 group">
                                <h1 class="font-bold text-md">Salon Profile</h1>
                                <div class="max-w-xs">
                                    <label for="example1" class="mb-1 block text-sm font-medium text-gray-700">Upload file</label>
                                    <input name="business_profile" id="business_profile" type="file" class="mt-2 block w-full text-sm file:mr-4 file:rounded-sm file:border-0 file:bg-teal-500 file:py-1 file:px-2 file:text-sm file:font-normal file:text-white hover:file:bg-teal-700 focus:outline-none disabled:pointer-events-none disabled:opacity-60" />
                                </div>
                            </div>
                            <div class="relative z-0 w-full mb-5 group">
                                <div class="max-w-xs">
                                    <label for="example1" class="mb-1 block text-sm font-medium text-gray-700">Upload 4 Image for this salon</label>
