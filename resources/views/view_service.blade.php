                    ...
                    <div class="group">
                        <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform transform scale-100 group-hover:scale-105">
                            ...
                            <div class="pb- text-center">
                                <button class="add_to_cart block w-full bg-green-500 py-1 px-4 text-center text-white rounded-sm" service_variant_id="{{$service_variant->id}}">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                @empty
